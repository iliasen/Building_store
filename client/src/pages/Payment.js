    ...
    return (
        <div className='payment-back'>
                <div className="payment-container">
                    ...
                    <ul><li>Вы можете оплатить покупку при доставке, рассчитываясь с курьером наличными деньгами.
                    </li><li>Если вы осуществляете самовывоз, оплату необходимо будет совершить в кассе пункта выдачи товара.</li></ul>
                    <div style={{ borderTop: "1px solid black"}}></div>
                    <p></p>

                    <h3>Банковские карты</h3>
                    <p><strong>Оплата банковской картой через терминал
                    </strong></p>
                    <ul><li>Оплата курьеру при доставке. Сообщите выбранный способ оплаты во время заказа, и курьер приедет к вам с терминалом.
                    </li><li>Также возможна оплата через терминалы во всех пунктах самовывоза.</li></ul>
                    <p>Оплата банковской картой онлайн *</p>
                    <ul><li>Оплата банковской картой VISA, MasterCard, МИР, UnionPay, БЕЛКАРТ  через систему Assist Belarus. Оплата производится через интернет в режиме реального времени непосредственно после оформления и подтверждения заказа.</li></ul>
                    <div style={{ borderTop: "1px solid black"}}></div>
                    <p></p>

                    <h3>По безналичному расчету (для юридических лиц)</h3>
                    <p>Счет-фактура на оплату заказа приходит на e-mail или факс, указанный при регистрации и создании кабинета вашей организации на сайте Гефест</p>
                    <div style={{ borderTop: "1px solid black"}}></div>
                    <p></p>
                    ...
                    <img src='https://mile.by/upload/medialibrary/ae0/assist.png'/>
                     ...
                     <p></p>
                    <p>1. Оплата банковской картой VISA, MasterCard, UnionPay, БЕЛКАРТ через систему Assist Belarus. Оплата производится через интернет в режиме реального времени непосредственно после оформления заказа.</p>
                    ...
                    <ul><li>на карте недостаточно средств для оплаты заказа;
                    </li><li>банк, выпустивший карточку покупателя, установил запрет на оплату в интернете;
                    </li><li>истекло время ожидания ввода данных банковской карты;
                    </li><li>введённые данные не были подтверждены вами на платежной странице, ошибка формата данных и.т.д.
                    </li></ul>

                    <p><strong>В зависимости от причины отказа в авторизации для решения вопроса вы можете:</strong></p>
                    <ul><li>обратиться за разъяснениями в банк, выпустивший карточку покупателя;
                    </li><li>в случае невозможности решения проблемы банком — повторить попытку оплаты, воспользовавшись картой, выпущенной другим банком.</li></ul>
                </div>
            </div>
        </div>
    )}
